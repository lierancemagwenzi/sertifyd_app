...
class ClientPaidWidget extends StatefulWidget {

  ClientApplication  clientApplication;
  ClientPaidWidget({Key key, this.clientApplication}) : super(key: key);

  @override
  _ClientPaidWidgetState createState() => _ClientPaidWidgetState();
}

class _ClientPaidWidgetState extends StateMVC<ClientPaidWidget> {

  ApplicationController _con;

  _ClientPaidWidgetState() : super(ApplicationController()) {
    _con = controller;
  }
              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    ...
                    title: Text("Amount Paid",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 12.0),),
...
trailing: Text("Open",style: TextStyle(color: Colors.black,fontSize: 12),),
          ...
          ListTile(
            ...
            subtitle: Text(  _con.certificationApplicationModel.zoom.start_time
              ,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 12.0),),
          ),
        ],
      ),
