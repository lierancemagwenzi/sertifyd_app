...
import 'package:horizon/src/controllers/ClientChatController.dart';
...
class ClientChatsWidget extends StatefulWidget {
  ...
  @override
  _ClientChatsWidgetState createState() => _ClientChatsWidgetState();
}

class _ClientChatsWidgetState extends StateMVC<ClientChatsWidget> {

  ClientChatController _con;

  _ClientChatsWidgetState() : super(ClientChatController()) {
    _con = controller;
  }
...
// _timer = Timer.periodic(Duration(minutes: 1), (Timer t) => _con.listenForChats());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body:_con.conversations.length<1?EmptyMessagesWidget():1==1?_body():ListView.builder(
