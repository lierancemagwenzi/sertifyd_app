...
class ApplicationViewWidget extends StatefulWidget {

  ClientApplication  clientApplication;
  ApplicationViewWidget({Key key, this.clientApplication}) : super(key: key);

  @override
  _ApplicationViewWidgetState createState() => _ApplicationViewWidgetState();
}

class _ApplicationViewWidgetState extends StateMVC<ApplicationViewWidget> {

  ApplicationController _con;

  _ApplicationViewWidgetState() : super(ApplicationController()) {
    _con = controller;
  }
              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    ...
                    title: Text("Amount",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 12.0),),
...
trailing: Icon(Icons.chat_bubble_outline,color: Colors.black,),
                    title: Text("Message Commissioner of Oaths",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 12.0),),
                ...
                children: [
                  Container(
                    ...
                    child: TabBar(
                      ...
                      tabs: [
                        Tab(text: "Zoom",),
                        Tab(text:"Commissioner of Oaths"),
                        Tab(text: "Documents",),
                      ],
                    ),
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: (){
              ...
              Map map={"action":"zoom_link","platform":Platform.isIOS?"ios":"android","user_id":currentuser.value.id??0,"device":detailsModel.value.identifier,"detail":"zoom",};
