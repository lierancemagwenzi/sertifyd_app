...
import 'package:horizon/src/elements/PayCertItem.dart';
...
class PaymentWidget extends StatefulWidget {
  ...
  PaymentWidget({Key key, this.clientApplication}) : super(key: key);
...
class _PaymentWidgetState extends StateMVC<PaymentWidget> {
  ...
  _PaymentWidgetState() : super(PaymentController()) {
    _con = controller;
  }
            ...
            child: Container(
              ...
              child: Row(children: [
                ...
                Expanded(
                  ...
                  child:                        Helper.TotalintPayPrice(_con.certificationApplicationModel)==0?Center(child: Text("None of your documents are eligible for payment",style: TextStyle(color: Theme.of(context).accentColor,fontSize: 10.0),)):
                  InkWell(
                    onTap: (){

                      if(Helper.TotalintPayPrice(_con.certificationApplicationModel)==0){


                      }

                      else{   _con.RequestForm(widget.clientApplication.id, context);}

                    },
                    child: Container(

                      child: Center(child: Text("Pay",style: TextStyle(color: Theme.of(context).accentColor,fontSize: 18.0,fontWeight: FontWeight.bold),)),
...
key: _con.scaffoldKey,
        appBar: AppBar(
         ...
         title: InkWell(
             ...
             child: Text("Application Details",style: TextStyle(color: Colors.black,fontSize: 15.0,fontWeight: FontWeight.bold),)),
                  ...
                  SliverToBoxAdapter(
                    child: Wrap(
                      children: [
                        ...
                        SizedBox(height: 100),
                        Helper.TotalintPayPrice(_con.certificationApplicationModel)==0?Center(child: Text("None of your documents are eligible for payment")):SizedBox(height: 0,),
                       SizedBox(height: 5,),
                       Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
                ...
                colors:Helper.TotalintPayPrice(_con.certificationApplicationModel)==0?[Theme.of(context).dividerColor,Theme.of(context).dividerColor]: [Theme.of(context).accentColor,Theme.of(context).accentColor])),
        child: Text(
          'Pay',
