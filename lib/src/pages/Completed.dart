...
class CompletedApplications extends StatefulWidget {
  ...
  @override
  _CompletedApplicationsState createState() => _CompletedApplicationsState();
}

class _CompletedApplicationsState extends StateMVC<CompletedApplications> {


  DownloadController _con;

  _CompletedApplicationsState() : super(DownloadController()) {
    _con = controller;
  }
...
//              padding: const EdgeInsets.symmetric(horizontal: 0, vertical: 10),
              child: Column(
                children: <Widget>[
                  ...
                  SizedBox(height: 20,),
                _con.applications.length==0?SizedBox(height: 0,width: 0,):  Card(
                  ...
                  _con.applications.length==0?SizedBox(height: 0,width: 0,):  Divider(color: Colors.grey,),
                      ...
                      return CertItemWidget(
                          ...
                          onClick: (model){
                            ...
                            if(model.status.status.toLowerCase()=='pending'){
                              ...
                              Navigator.of(context).pushNamed('/${model.status.client_next.toLowerCase()}', arguments: ClientApplication(id: model.id,message:null,client_next: model.status.client_next));
