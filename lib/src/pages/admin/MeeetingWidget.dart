...
class ApplicationMeetingWidget extends StatefulWidget {

      AdminApplicationModel adminApplicationModel;

  ApplicationMeetingWidget({Key key, this.adminApplicationModel}) : super(key: key);

  @override
  _ApplicationMeetingWidgetState createState() => _ApplicationMeetingWidgetState();
}

class _ApplicationMeetingWidgetState extends StateMVC<ApplicationMeetingWidget> {

  AdminController _con;

  _ApplicationMeetingWidgetState() : super(AdminController()) {
    _con = controller;
  }
  ...
  subtractTime(){
    ...
    DateTime parseDate = new DateFormat("yyyy-MM-ddTHH:mm:ssZ").parse(_con.certificationApplicationModel.zoom.start_time);
...
child:
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text("Action Documents",style: TextStyle(color: Theme.of(context).accentColor,fontSize: 12.0,fontWeight: FontWeight.bold),)),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 20),
                            _con.certificationApplicationModel.status.can_chat?  InkWell(

                              onTap: (){

                                Navigator.pushNamed(context, '/Messaging',arguments: _con.certificationApplicationModel.id);
                      ...
                      _con.certificationApplicationModel.documents.isEmpty
                        ...
                        child: ListTile(
                          ...
                          trailing: 1==1?OutlinedButton(
                            child: Text("Action Docs",style: TextStyle(color: Theme.of(context).accentColor),),
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  CupertinoPageRoute(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Action Docs",style: Theme.of(context).textTheme.headline4.copyWith(fontSize: 13.0),),
              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    ...
                    title: Text("Amount to pay",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 12.0),),
                  ...
                  ListTile(
                    ...
                    title: Text("Message Client",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 12.0),),
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: (){
              ...
              Map map={"action":"zoom_link","platform":Platform.isIOS?"ios":"android","user_id":currentuser.value.id??0,"device":detailsModel.value.identifier,"detail":"chat",};

              log_activity(map);
            },
            trailing: Text("Open",style: TextStyle(color: Colors.black,fontSize: 12),),
            title: Text("Meeting Link",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 12.0),),

            subtitle: Text(_con.certificationApplicationModel.zoom.join_url,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 12.0),),
          ),

          ListTile(

            title: Text("Meeting Password",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 12.0),),

            subtitle: Text(   _con.certificationApplicationModel.zoom.password
              ,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 12.0),),
          ),

          ListTile(

            title: Text("Meeting Time",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 12.0),),

            subtitle: Text(  _con.certificationApplicationModel.zoom.getMeetingDate()
              ,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 12.0),),
          ),
        ],
      ),
