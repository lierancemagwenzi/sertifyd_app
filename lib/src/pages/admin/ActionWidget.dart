...
class ActionApplicationWidget extends StatefulWidget {

  AdminApplicationModel adminApplicationModel;
  ActionApplicationWidget({Key key, this.adminApplicationModel}) : super(key: key);

  @override
  _ActionApplicationWidgetState createState() => _ActionApplicationWidgetState();
}

class _ActionApplicationWidgetState extends StateMVC<ActionApplicationWidget> {

  AdminController _con;

  _ActionApplicationWidgetState() : super(AdminController()) {
    _con = controller;
  }
                      ...
                      Expanded(
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: Center(child: Text("Create Meeting",style: TextStyle(color: Theme.of(context).accentColor,fontSize: 12.0,fontWeight: FontWeight.bold),)),
...
//             ),
  ...
  _submit(){
    ...
    if(_con.certificationApplicationModel.start_time.toLowerCase()=="immediately"){
      ...
      // print(parseDate.day.toString())
      zoomMeetingModel=new ZoomMeetingModel(start_time: _con.certificationApplicationModel.date);
      print(_con.certificationApplicationModel.date);
    }
                      ...
                      child: Center(
                        child: ListTile(
                          ...
                          subtitle: Padding(
                            ...
                            child: Text(_con.certificationApplicationModel.status.status,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 12.0),),
                          ),
                  ...
                  child: Column(
                    children: [
                      ...
                      ListTile(
                        ...
                        subtitle: Text(_con.certificationApplicationModel.getslotDate(),style: TextStyle(color: Colors.black,fontWeight: FontWeight.w500,fontSize: 10.0),),
                      ),
                      ListTile(
