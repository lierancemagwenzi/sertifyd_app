...
class AdminNotificationWidget extends StatefulWidget {
  ...
  AdminNotificationWidget({Key key, this.fromlauncher}) : super(key: key);
  @override
  _AdminNotificationWidgetState createState() => _AdminNotificationWidgetState();
}

class _AdminNotificationWidgetState extends StateMVC<AdminNotificationWidget> {


  NotificationController _con;

  _AdminNotificationWidgetState() : super(NotificationController()) {
    _con = controller;
  }
  double height;
  double width;
          ...
          return NotificationItemWidget(
            ...
            onClick: () {
              if(_con.notifications[index].action=="application"){
                ...
                _con.findAdminApplication(_con.notifications.elementAt(index).action_id,context);
