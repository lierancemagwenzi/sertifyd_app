...
class ApplicationProgress extends StatefulWidget {
...
String end_time;
  ...
  ApplicationProgress({Key key, this.title,this.fileitems,this.description,this.date,this.files,this.start_time,this.end_time}) : super(key: key);

  final String title;
  @override
  _ApplicationProgressState createState() => _ApplicationProgressState();
}

class _ApplicationProgressState extends StateMVC<ApplicationProgress> {

  SertifyerController _con;

  _ApplicationProgressState() : super(SertifyerController()) {
    _con = controller;
  }
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
                  ...
                  Container(
                    ...
                    child:  item.status == UploadTaskStatus.running
                      ...
                      child: CircularProgressIndicator(
                        ...
                        : Icon(
                      item.status == UploadTaskStatus.complete? Icons.check : Icons.error,
              ...
              item.status == UploadTaskStatus.complete?Text("Application submitted successfully.You will be notified when a Commissioner of Oaths picks your application",style: TextStyle( fontSize: 12.0,
  ...
  Future UploadFiles() async {
    final String url = '${GlobalConfiguration().getValue('api_base_url')}application/store';
    final tag = "Certification documents upload ${tasks.length + 1}";
