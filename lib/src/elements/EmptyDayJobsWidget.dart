...
class EmptyDayJobsWidget extends StatefulWidget {
  EmptyDayJobsWidget({
    Key key,
  }) : super(key: key);

  @override
  _EmptyDayJobsWidgetState createState() => _EmptyDayJobsWidgetState();
}

class _EmptyDayJobsWidgetState extends State<EmptyDayJobsWidget> {
  bool loading = true;
