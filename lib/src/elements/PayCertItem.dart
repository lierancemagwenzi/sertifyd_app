...
class PayCertItem extends StatefulWidget {
  final bool expanded;
  final CertificationApplicationModel applicationModel;
  final ValueChanged<void> onCanceled;
  final ValueChanged<void> onClick;
  PayCertItem({Key key, this.expanded, this.applicationModel, this.onCanceled,this.onClick}) : super(key: key);

  @override
  _PayCertItemState createState() => _PayCertItemState();
}

class _PayCertItemState extends State<PayCertItem> {
  @override
