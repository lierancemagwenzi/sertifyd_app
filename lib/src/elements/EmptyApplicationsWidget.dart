...
class EmptyDocumentsWidget extends StatefulWidget {
  EmptyDocumentsWidget({
    Key key,
  }) : super(key: key);

  @override
  _EmptyDocumentsWidgetState createState() => _EmptyDocumentsWidgetState();
}

class _EmptyDocumentsWidgetState extends State<EmptyDocumentsWidget> {
  bool loading = true;
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Opacity(
                opacity: 0.4,
                child: Text(
                  "You do not have any recent certification applications"    ,
