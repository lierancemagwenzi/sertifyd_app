...
class EmptyCompletedWidget extends StatefulWidget {
  EmptyCompletedWidget({
    Key key,
  }) : super(key: key);

  @override
  _EmptyCompletedWidgetState createState() => _EmptyCompletedWidgetState();
}

class _EmptyCompletedWidgetState extends State<EmptyCompletedWidget> {
  bool loading = true;
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Opacity(
                opacity: 0.4,
                child: Text(
                  "You do not have any completed certifications for download" ,
