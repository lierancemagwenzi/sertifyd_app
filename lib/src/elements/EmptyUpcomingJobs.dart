...
class EmptyUpcomingJobs extends StatefulWidget {
  EmptyUpcomingJobs({
    Key key,
  }) : super(key: key);

  @override
  _EmptyUpcomingJobsState createState() => _EmptyUpcomingJobsState();
}

class _EmptyUpcomingJobsState extends State<EmptyUpcomingJobs> {
  bool loading = true;
