...
class EmptyDyCertifications extends StatefulWidget {
  EmptyDyCertifications({
    Key key,
  }) : super(key: key);

  @override
  _EmptyDyCertificationsState createState() => _EmptyDyCertificationsState();
}

class _EmptyDyCertificationsState extends State<EmptyDyCertifications> {
  bool loading = true;
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Opacity(
                opacity: 0.4,
                child: Text(
                  "You do not have any certifications for this day"    ,
