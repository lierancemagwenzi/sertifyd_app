...
import 'package:horizon/src/icons/empty_folder.dart';
import 'package:horizon/src/pages/Home.dart';




class EmptyScheduledJobs extends StatefulWidget {
  EmptyScheduledJobs({
    Key key,
  }) : super(key: key);

  @override
  _EmptyScheduledJobsState createState() => _EmptyScheduledJobsState();
}

class _EmptyScheduledJobsState extends State<EmptyScheduledJobs> {
  bool loading = true;
              ...
              Stack(
                children: <Widget>[
                  Container(
                    ...
                    child: Icon(
EmptyFolder.empty_folder,                      color: Theme.of(context).primaryColorLight,
                      size: 70,
                    ),
                  ),
                  Positioned(
